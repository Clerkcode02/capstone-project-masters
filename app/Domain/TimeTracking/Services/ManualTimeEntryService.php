...
{
    /**
     * @param  array{task_id: int|null, account_id: int|null, log_date: string, hour_type: string, duration_minutes: int, notes: string|null}  $data
     */
    public function log(User $user, array $data): TimeLog
    {
